    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Binarycoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  binarycoind [options]                     " + "\n" +
                  "  binarycoind [options] <command> [params]  " + _("Send command to -server or binarycoind") + "\n" +
                  "  binarycoind [options] help                " + _("List commands") + "\n" +
                  "  binarycoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: binarycoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 25202 or testnet: 125202)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 25203 or testnet: 125203)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Binarycoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Binarycoin is probably already running."), strDataDir.c_str()));
